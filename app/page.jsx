...
export default function Home() {
  // 클라이언트에서만 렌더링하기 위한 마운트 상태
  // 서버에서는 false → 로딩 화면, 클라이언트에서 true → 게임 화면
  // 이렇게 하면 hydration mismatch를 방지할 수 있음
      ...
      <div id="game-screen" className="screen">
        ...
        <div className="status-bar">
          ...
          <div className="status-card">
            ...
            <span id="current-faith" className="status-value" />
            <span id="faith-per-second" className="status-sub" />
          </div>
          <div className="status-card">
        ...
        <div className="main-area">
          ...
          <div className="side-panel left-panel">
            <div className="share-card">
              <h3 className="panel-title">공유 카드 미리보기</h3>
          ...
          <div className="side-panel right-panel">
            ...
            <ul id="event-log" className="event-log" />
          </div>
        </div>
        ...
        <div className="bottom-bar">
          <div className="game-controls">
            <button id="new-game-btn" className="btn btn-danger">새 게임 시작</button>
          </div>
        </div>
      </div>
      ...
      <div id="ending-screen" className="screen">
        <div className="ending-container">
          ...
          <div className="ending-buttons">
            <button id="ending-share-btn" className="btn btn-primary">결과 공유하기</button>
...
function ScriptLoader() {
  useEffect(() => {
    ...
    // 스크립트 로드 완료 후 initGame 호출
    script.onload = () => {
      // 스크립트가 로드되면 전역으로 노출된 initGame 함수 호출
